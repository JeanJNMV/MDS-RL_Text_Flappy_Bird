...
We consider two variants of the environment, simple and screen, implemented using a custom OpenAI Gym framework, each with different levels of complexity and observation spaces. The problem is modeled as a Markov Decision Process, and we explore two RL algorithms: Monte Carlo Control and Sarsa($\lambda$).

This report evaluates and compares their performance and convergence across both environments, along with a sensitivity analysis of key hyperparameters and an examination of policy transferability.
